...
INI_PATH=${O2DPG_ROOT}/MC/config/PWGHF/ini/GeneratorHF_D2H_ccbar_and_bbbar_PbPb_corrBkg.ini # .ini file path

export ALIEN_JDL_ANCHOR_SIM_OPTIONS="-gen external -ini $INI_PATH -genBkg pythia8 -procBkg heavy_ion -colBkg PbPb --embedding --embeddPattern @0:e2"
